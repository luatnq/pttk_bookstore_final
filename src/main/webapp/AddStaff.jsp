...
%>
<form action="./StaffServlet" method="post" class="form-signin">
    ...
    <label for="staffCode" class="sr-only">Staff code:</label>
    <input type="tel" class="form-control" name="staffCode" id="staffCode" placeholder="Staff code" /></br>
