...
%>
<div class="alert alert-danger" style="max-width: 330px; margin: 0 auto" role="alert">Please sign in to continue
    checkout
</div>
<%
    }
...
<div>
    <a href="Register.jsp" style="height: 50px; width: 300px; margin-left: 420px" class="btn btn-lg btn-primary btn-block">Register</a>
</div>
